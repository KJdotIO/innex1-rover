...
bool odom_only;
std::string odom_header_frame_id, odom_child_frame_id, odom_topic;
...
bool scan_pub_en, scan_body_pub_en, publish_tf_en;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<std::string>("odometry.topic", "/odom_corrected");
    ...
    nh->declare_parameter<bool>("publish.publish_tf", true);
    ...
    nh->get_parameter("odometry.topic", odom_topic);
    ...
    nh->get_parameter("publish.publish_tf", publish_tf_en);
